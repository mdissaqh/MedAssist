...
export const addHospitalApi = async (hospitalData) => {
  const response = await axiosInstance.post('api/admin/hospitals', hospitalData);
  return response.data;
};

export const editHospitalApi = async (id, hospitalData) => {
  const response = await axiosInstance.put(`api/admin/hospitals/${id}`, hospitalData);
  return response.data;
};

export const searchHospitalsApi = async (query) => {
  const response = await axiosInstance.get(`api/admin/hospitals/search?query=${query}`);
  return response.data;
};
