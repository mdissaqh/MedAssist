...
const SYMPTOMS_DICT = {
  'English': ["Severe Chest Pain", "Sudden Weakness/Speech Loss", "No Pulse/Collapsed", "Severe Asthma Attack", "Severe external bleeding", "Brain Hemorrhage", "Seizure(uncontrolled movements)", "Snake Bite"],
